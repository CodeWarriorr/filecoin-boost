...
/// @notice Computes ABI calldata for DataCapEvidenceAdapter.submitDataCapBatch().
contract ComputeDataCapBatchCalldata is Script {
    function run() external view {
        ...
        bytes memory operatorData = _buildOperatorData(provider, pieceCid, pieceSize, 518400, 5256000, expiration);
